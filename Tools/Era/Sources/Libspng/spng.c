...
#define SPNG_TARGET_CLONES(x)
    ...
    #ifndef SPNG_DISABLE_OPT
        __attribute__((force_align_arg_pointer)) static void defilter_sub3(size_t rowbytes, unsigned char *row);
        __attribute__((force_align_arg_pointer)) static void defilter_sub4(size_t rowbytes, unsigned char *row);
        __attribute__((force_align_arg_pointer)) static void defilter_avg3(size_t rowbytes, unsigned char *row, const unsigned char *prev);
        __attribute__((force_align_arg_pointer)) static void defilter_avg4(size_t rowbytes, unsigned char *row, const unsigned char *prev);
        __attribute__((force_align_arg_pointer)) static void defilter_paeth3(size_t rowbytes, unsigned char *row, const unsigned char *prev);
        __attribute__((force_align_arg_pointer)) static void defilter_paeth4(size_t rowbytes, unsigned char *row, const unsigned char *prev);
    #endif
#endif
