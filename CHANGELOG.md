...
#### WoG:
- The "game bug fixes extended.dll" plugin has been updated:
    - now, when units completely block damage, the damage inflicted message will no longer be displayed;
...
- mod updated to version 1.1:
    ...
    - Casting Clone Spell costs additional spell points, based on number and target level. Clone can be by far the "best damage" spell. This balances the costs a bit. Ratio may change in the future.
    - Slightly lowered the chance to evade attacks with Pegasus Harness set.
    ...
    - Restored missing compund set descriptionm which was lost due to changes in the GEM mod
    - Fixed Torosar native block ability disappearing during combat
    - Fixed Champions Honor Set bonus partly not working (thanks to TheInvisible)
    - Corrected Luck proc in combat. Negative Luck might still be a problem with the newest launcher updates.

#### Game Enhancement Mod:
- Fixed a bug that occurred when starting maps with modified town buildings;
